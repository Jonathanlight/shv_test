 ...
 */
final class Version20190321163730 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rmp_validation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, rmp_id INT NOT NULL, active TINYINT(1) NOT NULL, updated_at DATETIME DEFAULT NULL, created_at DATETIME DEFAULT NULL, INDEX IDX_A94F2F01A76ED395 (user_id), INDEX IDX_A94F2F0164B5022B (rmp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE rmp_validation ADD CONSTRAINT FK_A94F2F01A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE rmp_validation ADD CONSTRAINT FK_A94F2F0164B5022B FOREIGN KEY (rmp_id) REFERENCES rmp (id)');
        $this->addSql('DROP TABLE hedge_validation');
        $this->addSql('ALTER TABLE hedge ADD validator_level2_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE rmp_validation');
