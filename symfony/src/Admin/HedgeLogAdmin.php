...
final class HedgeLogAdmin extends AbstractAdmin
{
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        ...
        $listMapper->add('type', null, ['template' => 'admin/hedge_log_column_field_type.html.twig', 'row_align' => 'left']);
    }

    protected function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        $datagridMapper->add('type', null, [], ChoiceType::class, [
            'choices' => array_flip(HedgeLog::$typeActionsLabels),
